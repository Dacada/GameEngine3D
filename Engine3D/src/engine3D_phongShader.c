...
#else
	engine3D_shader_addVertexShader(engine3D_resourceLoader_loadShader("phongVertex_ES.vs", shaderText, 65536), (engine3D_shader_t*)shader);
	engine3D_shader_addFragmentShader(engine3D_resourceLoader_loadShader("phongFragment_ES.fs", shaderText, 65536), (engine3D_shader_t*)shader);
#endif
